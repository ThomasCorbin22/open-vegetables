...
describe("RestaurantService testing with restaurantservice", () => {
  let new_restaurant = {
    ...
    logo:
      "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse4.mm.bing.net%2Fth%3Fid%3DOIP.bYCGq485SZLPBgm-0oj_qAAAAA%26pid%3DApi&f=1",
    price: 3,
  ...
  let altered_restaurant = {
    ...
    description: "This is a placeholder restaurant. Please select another.",
    logo:
      "https://external-content.duckduckgo.com/iu/?u=https%3A%2F%2Ftse1.mm.bing.net%2Fth%3Fid%3DOIP.6iu2HE0CMnwIpGvu66bMaAHaFj%26pid%3DApi&f=1",
    price: 2,
  ...
  test("restaurantService should call searchRestaurants properly", () => {
    ...
    return restaurantService.searchRestaurants(query).then((results) => {
      expect(results.length).toBe(1);
      expect(results[0].name).toBe("Our awesome restaurant");
      expect(results[0].street_address).toBe("Xccelerate");
      expect(results[0].description).toBe(
        "This is a placeholder restaurant. Please select another."
      );
    });
  });
  ...
  test("restaurantService should call listRestaurants", () => {
    ...
    return restaurantService.listRestaurants().then((results) => {
  ...
  test("restaurantService should call getRestaurant", () => {
    ...
    return restaurantService.getRestaurant(id).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call addRestaurant", () => {
    ...
    return restaurantService.addRestaurant(new_restaurant).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call updateRestaurant", () => {
    ...
    return restaurantService
      ...
      .then((results) => {
        ...
        expect(results[0].street_address).toBe(
          altered_restaurant.street_address
        );
  ...
  test("restaurantService should call deleteRestaurant", () => {
    ...
    return restaurantService.deleteRestaurant(id).then((result) => {
      expect(result).toBe(true);

      return restaurantService.listRestaurants().then((list) => {
  ...
  test("restaurantService should call listPictures", () => {
    ...
    return restaurantService.listPictures(1).then((results) => {
      expect(results.length).toBe(1);
      expect(results[0].picture_URL).toBe(
        "https://images.pexels.com/photos/1036857/pexels-photo-1036857.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"
      );
  ...
  test("restaurantService should call getPicture", () => {
    ...
    return restaurantService.getPicture(id).then((results) => {
      expect(results.length).toBe(1);
      expect(results[0].picture_URL).toBe(
        "https://images.pexels.com/photos/34650/pexels-photo.jpg?auto=compress&cs=tinysrgb&dpr=1&w=500"
      );
  ...
  test("restaurantService should call postPicture", () => {
    ...
    return restaurantService.addPicture(new_picture).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call putPicture", () => {
    ...
    return restaurantService
      .updatePicture(altered_picture, id)
      .then((results) => {
        expect(results.length).toBe(1);
  ...
  test("restaurantService should call deletePicture", () => {
    ...
    return restaurantService.deletePicture(id).then((result) => {
      expect(result).toBe(true);

      return restaurantService.getPicture(id).then((list) => {
  ...
  test("restaurantService should call listCategories", () => {
    ...
    return restaurantService.listCategories(1).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call getCategory", () => {
    ...
    return restaurantService.getCategory(id).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call postCategory", () => {
    ...
    return restaurantService.addCategory(new_category).then((results) => {
      expect(results.length).toBe(1);
  ...
  test("restaurantService should call putCategory", () => {
    ...
    return restaurantService
      .updateCategory(altered_category, id)
      .then((results) => {
        expect(results.length).toBe(1);
  ...
  test("restaurantService should call deleteCategory", () => {
    ...
    return restaurantService.deleteCategory(id).then((result) => {
      expect(result).toBe(true);

      return restaurantService.getCategory(id).then((list) => {
        expect(list.length).toBe(0);
      });
    });
  });
